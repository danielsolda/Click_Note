-- ClickNote MVP — Schema principal
-- Banco: PostgreSQL (Railway)
-- Aplicar via: npm run db:migrate  (scripts/migrate.js)
-- ou via bootstrap legado: npm run db:bootstrap
...
-- ---------------------------------------------------------------------------
-- Tabela: recurring_generated (controle de idempotência para recorrência)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- View: vw_tasks_waiting_followup
-- ---------------------------------------------------------------------------
